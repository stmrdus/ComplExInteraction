...
class Main(object):
    ...
    def add_model(self):
        ...
        """
        model = ComplExInteractE(self.p, self.chequer_perm)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data',           dest="dataset",
                        default='FB15k-237',            		help='Dataset to use for the experiment')
    ...
    parser.add_argument('--neg_num',        dest="neg_num",         default=1000,
                        type=int,       	help='Number of negative samples to use for loss calculation')
    ...
    parser.add_argument("--num_workers",	type=int,               default=0,
                        help='Maximum number of workers used in DataLoader')
    parser.add_argument('--seed',           dest="seed",
                        default=42,   		type=int,       	help='Seed to reproduce results')
    ...
    parser.add_argument('--form',		type=str,
                        default='plain',            			help='The reshaping form to use')
    ...
    parser.add_argument('--num_filt',  	dest="num_filt",      	default=96,
                        type=int,       	help='Number of filters in convolution')
    parser.add_argument('--ker_sz',    	dest="ker_sz",
                        default=9,     		type=int,       	help='Kernel size to use')
    parser.add_argument('--perm',      	dest="perm",          	default=1,
                        type=int,       	help='Number of Feature rearrangement to use')
    parser.add_argument('--hid_drop',  	dest="hid_drop",      	default=0.5,
                        type=float,     	help='Dropout for Hidden layer')
    parser.add_argument('--feat_drop', 	dest="feat_drop",
                        default=0.5,    	type=float,     	help='Dropout for Feature')
    parser.add_argument('--inp_drop',  	dest="inp_drop",      	default=0.2,
                        type=float,     	help='Dropout for Input layer')
